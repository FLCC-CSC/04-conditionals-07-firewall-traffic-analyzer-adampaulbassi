...
# NAME:Adam Bassi 
# DATE:3/2/2026 
# BRIEF DESCRIPTION:Firewall Traffi Analyzer  
...
# This program analyzes network traffic based on port number
# and data transfer size. It categorizes the traffic risk level
# using conditionals and prints a firewall log summary.
def main():
...
Yes I had to try switching between them to understand how they work and get the correct outcome.
